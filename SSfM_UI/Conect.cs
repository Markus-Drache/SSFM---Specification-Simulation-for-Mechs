...
namespace DB_Conektion
{
    class Conect
    {
        ...
        private string database = "DummyDB.db";
        ...
        {
            string sql = $"SELECT * FROM TechnologyNiveaus;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM TechnologyAvailabilityen;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM InternealStruktur;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM InternalStructureIntegrity;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM Musculature;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM Activator;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM Gyroscope;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM ReactorWeight;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM SpecialMovement;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM HeadSize;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM CockpitSystem;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM HeatSink;";
            return QueryAsDataTable(sql);
        }
        ...
        {
            string sql = $"SELECT * FROM SingleEquipmentByID WHERE id = {id};";
            return QueryAsDataTable(sql);
        }
